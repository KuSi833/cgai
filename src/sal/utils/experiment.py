...
Math500Subset = Literal["hard", "crash_debug", "crash_debug2", "bon_hard_2"]
...
def get_model_base_path() -> Path:
    MODEL_BASE_PATH_LOCAL = Path("/data/$USER/search-and-learn/models")
    MODEL_BASE_PATH_GIT_BUCKET = Path("/vol/bitbucket/$USER/search-and-learn/models")
